                            ...
                            <tbody>
                                ...
                                @foreach ($products as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('kitchen.discount.edit',$value->id)}}" class="mr-2"><i class="fas fa-edit text-info font-16"></i></a>

                                            <form action="{{route('kitchen.discount.destroy',$value->id)}}" method="post" style="display: inline-block">
                                                @method('delete')
                                                @csrf
