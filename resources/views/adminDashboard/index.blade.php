                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="media">
                                    <img src="/adminDashboard/assets/images/logo-sm.png" height="40" class="mr-4 align-self-center" alt="...">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="" src="/adminDashboard/assets/images/products/img-1.png" alt="user"> </td>
                                        <td>
                                            Beg
                                        </td>
                                        <td>
                                            <img src="/adminDashboard/assets/images/flags/us_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="" src="/adminDashboard/assets/images/products/img-2.png" alt="user"> </td>
                                        <td>
                                            Watch
                                        </td>
                                        <td>
                                            <img src="/adminDashboard/assets/images/flags/french_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="" src="/adminDashboard/assets/images/products/img-3.png" alt="user"> </td>
                                        <td>
                                            Headphone
                                        </td>
                                        <td>
                                            <img src="/adminDashboard/assets/images/flags/spain_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="" src="/adminDashboard/assets/images/products/img-4.png" alt="user"> </td>
                                        <td>
                                            Purse
                                        </td>
                                        <td>
                                            <img src="/adminDashboard/assets/images/flags/russia_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="" src="/adminDashboard/assets/images/products/img-5.png" alt="user"> </td>
                                        <td>
                                            Shoe
                                        </td>
                                        <td>
                                            <img src="/adminDashboard/assets/images/flags/italy_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-top-0">
                                            <div class="media">
                                                <img src="/adminDashboard/assets/images/products/img-7.png" height="80" class="mr-4" alt="...">
                                                <div class="media-body align-self-center">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="/adminDashboard/assets/images/products/img-3.png" height="80" class="mr-4" alt="...">
                                                <div class="media-body align-self-center">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <img src="/adminDashboard/assets/images/products/img-1.png" height="80" class="mr-4" alt="...">
                                                <div class="media-body align-self-center">
                            ...
                            <ul class="nav nav-pills justify-content-center text-center mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-credit-card-tab" data-toggle="pill" href="#pills-credit-card">
                                        <img src="/adminDashboard/assets/images/cards/card-1.png" alt=""  class="img-fluid">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-paypal-tab" data-toggle="pill" href="#pills-paypal">
                                        <img src="/adminDashboard/assets/images/cards/card-2.png" alt=""  class="img-fluid">
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-bitcoin-tab" data-toggle="pill" href="#pills-bitcoin">
                                        <img src="/adminDashboard/assets/images/cards/card-3.png" alt=""  class="img-fluid">
                                    </a>
                                </li>
                            </ul>
